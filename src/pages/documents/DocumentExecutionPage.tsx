...
const PLACEHOLDER_FIELDS = [
  { id: 'f-1', label: 'Sample ID', type: 'text', required: true, validationRule: null },
  { id: 'f-2', label: 'Batch Number', type: 'text', required: true, validationRule: null },
  { id: 'f-3', label: 'Assay Result (%)', type: 'number', required: true, validationRule: { type: 'range', min: 98.0, max: 102.0, ootMin: 97.0, ootMax: 103.0 } },
  { id: 'f-4', label: 'pH Value', type: 'number', required: false, validationRule: { type: 'range', min: 6.5, max: 7.5, ootMin: 6.2, ootMax: 7.8 } },
  { id: 'f-5', label: 'Water Content (%w/w)', type: 'number', required: false, validationRule: { type: 'max', max: 0.5, ootMax: 0.7 } },
  { id: 'f-6', label: 'Analyst Signature', type: 'text', required: true, validationRule: null },
  { id: 'f-7', label: 'Date of Analysis', type: 'date', required: true, validationRule: null },
  { id: 'f-8', label: 'Comments', type: 'textarea', required: false, validationRule: null },
];
...
export default function DocumentExecutionPage() {
  ...
  const fields = Array.isArray((parsedData as any)?.fields) && (parsedData as any).fields.length > 0
  ...
  const instruments: { id: string; label: string }[] = Array.isArray(instrumentsData)
    ...
    : [
        ...
        { id: 'ins-5', label: 'Balance-01 (Mettler Toledo)' },
      ];
