...
const PLACEHOLDER_DOCS: DocumentRow[] = [
  { id: '1', docId: 'DOC-2024-001', title: 'HPLC Method Validation Protocol', type: 'Method', status: 'Published', version: 3, updatedAt: '2026-05-20' },
  { id: '2', docId: 'DOC-2024-002', title: 'Dissolution Testing SOP', type: 'SOP', status: 'Approved', version: 2, updatedAt: '2026-05-22' },
  { id: '3', docId: 'DOC-2024-003', title: 'Microbial Limits Test Procedure', type: 'Procedure', status: 'Under Review', version: 1, updatedAt: '2026-05-25' },
  { id: '4', docId: 'DOC-2024-004', title: 'Water Content Analysis (KF)', type: 'Method', status: 'Draft', version: 1, updatedAt: '2026-05-26' },
  { id: '5', docId: 'DOC-2024-005', title: 'Stability Study Protocol – Product A', type: 'Protocol', status: 'Published', version: 4, updatedAt: '2026-05-18' },
  { id: '6', docId: 'DOC-2024-006', title: 'pH Measurement SOP', type: 'SOP', status: 'Approved', version: 2, updatedAt: '2026-05-21' },
  { id: '7', docId: 'DOC-2024-007', title: 'Impurity Testing Specification', type: 'Specification', status: 'Retired', version: 5, updatedAt: '2026-04-10' },
  { id: '8', docId: 'DOC-2024-008', title: 'Laboratory Safety Guidelines', type: 'Guideline', status: 'Published', version: 2, updatedAt: '2026-03-15' },
];
...
export default function DocumentsPage() {
  ...
  const rows: DocumentRow[] = Array.isArray(apiDocs) && (apiDocs as any[]).length > 0
      ...
      <Card>
        ...
        {isError && (
          <Alert severity="warning" sx={{ mx: 2, mt: 2 }}>
            Could not load documents from server. Showing sample data.
          </Alert>
        )}
